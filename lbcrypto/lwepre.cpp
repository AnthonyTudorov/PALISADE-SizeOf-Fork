...
bool LPAlgorithmPRELWENTRU<T,P>::ProxyGen(const LPPublicKey<Element,ElementParams> &newPublicKey, 
...
{
	const LPCryptoParameters<Element,ElementParams> &cryptoParams = newPublicKey.GetAbstractCryptoParameters();
