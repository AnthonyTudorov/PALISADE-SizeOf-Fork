...
BENCHMARK(X)->ArgName("parm_8_30")->Arg(0); \
BENCHMARK(X)->ArgName("parm_8_60")->Arg(1); \
BENCHMARK(X)->ArgName("parm_8_100")->Arg(2); \
BENCHMARK(X)->ArgName("parm_16_30")->Arg(3); \
BENCHMARK(X)->ArgName("parm_16_60")->Arg(4); \
BENCHMARK(X)->ArgName("parm_16_100")->Arg(5); \
BENCHMARK(X)->ArgName("parm_32_30")->Arg(6); \
BENCHMARK(X)->ArgName("parm_32_60")->Arg(7); \
BENCHMARK(X)->ArgName("parm_32_100")->Arg(8); \
BENCHMARK(X)->ArgName("parm_64_30")->Arg(9); \
BENCHMARK(X)->ArgName("parm_64_60")->Arg(10); \
BENCHMARK(X)->ArgName("parm_64_100")->Arg(11); \
BENCHMARK(X)->ArgName("parm_128_30")->Arg(12); \
BENCHMARK(X)->ArgName("parm_128_60")->Arg(13); \
BENCHMARK(X)->ArgName("parm_128_100")->Arg(14); \
BENCHMARK(X)->ArgName("parm_256_30")->Arg(15); \
BENCHMARK(X)->ArgName("parm_256_60")->Arg(16); \
BENCHMARK(X)->ArgName("parm_256_100")->Arg(17); \
BENCHMARK(X)->ArgName("parm_512_30")->Arg(18); \
BENCHMARK(X)->ArgName("parm_512_60")->Arg(19); \
BENCHMARK(X)->ArgName("parm_512_100")->Arg(20); \
BENCHMARK(X)->ArgName("parm_1024_30")->Arg(21); \
BENCHMARK(X)->ArgName("parm_1024_60")->Arg(22); \
BENCHMARK(X)->ArgName("parm_1024_100")->Arg(23); \
BENCHMARK(X)->ArgName("parm_2048_30")->Arg(24); \
BENCHMARK(X)->ArgName("parm_2048_60")->Arg(25); \
BENCHMARK(X)->ArgName("parm_2048_100")->Arg(26); \
BENCHMARK(X)->ArgName("parm_4096_30")->Arg(27); \
BENCHMARK(X)->ArgName("parm_4096_60")->Arg(28); \
BENCHMARK(X)->ArgName("parm_4096_100")->Arg(29); \
BENCHMARK(X)->ArgName("parm_8192_30")->Arg(30); \
BENCHMARK(X)->ArgName("parm_8192_60")->Arg(31); \
BENCHMARK(X)->ArgName("parm_8192_100")->Arg(32); \


#define DO_PARM_BENCHMARK_TEMPLATE(X,Y) \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_8_30")->Arg(0); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_8_60")->Arg(1); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_8_100")->Arg(2); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_16_30")->Arg(3); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_16_60")->Arg(4); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_16_100")->Arg(5); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_32_30")->Arg(6); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_32_60")->Arg(7); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_32_100")->Arg(8); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_64_30")->Arg(9); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_64_60")->Arg(10); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_64_100")->Arg(11); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_128_30")->Arg(12); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_128_60")->Arg(13); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_128_100")->Arg(14); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_256_30")->Arg(15); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_256_60")->Arg(16); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_256_100")->Arg(17); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_512_30")->Arg(18); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_512_60")->Arg(19); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_512_100")->Arg(20); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_1024_30")->Arg(21); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_1024_60")->Arg(22); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_1024_100")->Arg(23); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_2048_30")->Arg(24); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_2048_60")->Arg(25); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_2048_100")->Arg(26); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_4096_30")->Arg(27); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_4096_60")->Arg(28); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_4096_100")->Arg(29); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_8192_30")->Arg(30); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_8192_60")->Arg(31); \
BENCHMARK_TEMPLATE(X,Y)->ArgName("parm_8192_100")->Arg(32); \
