...
make install DESTDIR=$PWD/../prebuilt/x86
...
make install DESTDIR=$PWD/../prebuilt/x86_64
( cd ../prebuilt/x86_64 && mv usr/lib/libgmp.so usr/lib/libgmpxx.so usr/include/gmp.h usr/include/gmpxx.h . && rm -rf usr )
make distclean
