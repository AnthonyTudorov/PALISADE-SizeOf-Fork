...
//	TestDCRTVecDecompose(16,32,1024);
...
//	nextQ2 = lbcrypto::NextPrime<native_int::BigInteger>(nextQ, n);
	...
	std::cout << "nextQ2: " << nextQ2 << std::endl;
...
//	BigInteger bigModulus("2251799814725633");
...
//	BigInteger bigRootOfUnity("794438271477401");
...
//	ChineseRemainderTransformFTT<native_int::BigInteger, BigVector>::GetInstance().PreCompute(rootOfUnity, n, q);
	...
	//	std::cout << "Printing original plaintext" << std::endl;

	//	ptext1.PrintValues();

	//	std::cout << "Printing decrypted and decoded text" << std::endl;
	//	dtextPoly.PrintValues();
