...
#ifndef PALISADE_STUDENT_EDITION_UNIFORMINTEGERGENERATOR_H
#define PALISADE_STUDENT_EDITION_UNIFORMINTEGERGENERATOR_H
...
#endif //PALISADE_STUDENT_EDITION_UNIFORMINTEGERGENERATOR_H
